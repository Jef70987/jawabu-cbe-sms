          ...
          <div className="flex items-center justify-between px-4 py-2">
            ...
            >
              ...
              <div className="flex flex-col leading-tight">
                ...
                <h2 className="text-white text-[10px] font-semibold leading-tight">Register Portal</h2>
              </div>
            </button>
            <div className="text-right">
              <p className="text-white text-xs font-semibold">{user?.username || 'User'}</p>
              <p className="text-green-200 text-[10px] font-medium">{user?.role || 'Register'}</p>
            </div>
          </div>
        </div>
      )}
            ...
            <div className={`flex items-center ${isCollapsed ? 'flex-col' : 'space-x-4'}`}>
              ...
              {!isCollapsed && (
                <div className="flex flex-col">
                  ...
                  <h2 className="text-white text-xs font-semibold">REGISTER PORTAL</h2>
                  <p className="text-sm font-extrabold text-white truncate">{user?.username || 'User'} | {user?.role || 'Register'}</p>
                </div>
              )}
            </div>
