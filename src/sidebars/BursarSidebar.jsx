...
function BursarSidebar({ children }) {
          ...
          <div className="flex items-center justify-between px-4 py-2">
            ...
            >
              ...
              <div className="flex flex-col leading-tight">
                ...
                <h2 className="text-white text-[10px] font-semibold leading-tight">Bursar Portal</h2>
              </div>
            </button>
            <div className="text-right">
              <p className="text-white text-xs font-semibold">{user?.username || 'User'}</p>
              <p className="text-green-200 text-[10px] font-medium">{user?.role || 'bursar'}</p>
            </div>
          </div>
        </div>
      )}
