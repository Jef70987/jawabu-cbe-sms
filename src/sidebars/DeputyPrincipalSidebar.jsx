  ...
  return (
    <>
      ...
      {isMobile && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900 to-blue-800 shadow-lg z-50 lg:hidden">
          <div className="flex justify-around items-center h-12 px-2">
            {DeputyPrincipalSidebarData.slice(0, 5).map((val, key) => (
              <button
                key={key}
      ...
      >
        ...
        {!isCollapsed && (
          <div className="relative z-10 mx-3 mt-3 p-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 border border-blue-500/50 shadow-lg">
                      ...
                      <li key={subKey}>
                        <div
                          className={`
                            ...
                            ${window.location.pathname === subVal.path 
          ...
          <div className={`text-white/80 transition-all duration-300 ${isCollapsed ? 'text-xs' : 'text-sm'}`}>
            {!isCollapsed ? (
              ...
              <div className="flex flex-col items-center">
                <span className="text-xs font-bold text-blue-300">v2.0.0</span>
              </div>
            )}
          </div>
        </div>
