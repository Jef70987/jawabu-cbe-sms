...
const Toast = ({ message, type, onClose }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 animate-slideIn">
      <div
        className={`${bgColor[type]} text-white rounded-lg shadow-xl p-4 min-w-[320px] max-w-md`}
      >
...
const StaffSearchModal = ({ isOpen, onClose, onSelect, title, staffList }) => {
  ...
  const filteredStaff = staffList.filter((staff) =>
    `${staff.first_name} ${staff.last_name} ${staff.staff_id} ${staff.department}`
      .toLowerCase()
              ...
              {filteredStaff.map((staff) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${staff.status === "Active" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                    >
                      {staff.status}
                    </span>
                  </div>
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          <h3 className="text-lg font-semibold text-gray-900">
            Request Leave for {staff?.first_name} {staff?.last_name}
          </h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-500"
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-[95]">
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          <h3 className="text-lg font-semibold text-gray-900">
            Apply for Loan - {staff?.first_name} {staff?.last_name}
          </h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-500"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, repayment_months: e.target.value })
                }
                required
                min="1"
                max="60"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, guarantor_name: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    guarantor_contact: e.target.value,
                  })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500"
              />
  ...
  const fetchLeaveData = async () => {
    ...
    try {
      ...
      const leavesRes = await fetch(
        `${API_BASE_URL}/api/hr/staff/${staffId}/leaves/`,
        {
      ...
      const balanceRes = await fetch(
        `${API_BASE_URL}/api/hr/staff/${staffId}/leave-balance/`,
        {
          headers: getAuthHeaders(),
        },
      );
  ...
  const fetchLoanData = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/hr/staff/${staffId}/loans/`,
        {
          headers: getAuthHeaders(),
        },
      );
...
const StaffManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        showToast(
          `Staff member ${formMode === "create" ? "created" : "updated"} successfully`,
          "success",
        );
        setShowForm(false);
        resetForm();
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      if (data.success) {
        showToast(
          `Successfully imported ${data.data.created_count} staff members`,
          "success",
        );
  ...
  const submitLeaveRequest = async (staffId, leaveData) => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/hr/staff/${staffId}/leaves/create/`,
        {
          method: "POST",
          headers: getAuthHeaders(),
  ...
  const submitLoanRequest = async (staffId, loanData) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/api/hr/staff/${staffId}/loans/create/`,
        {
          method: "POST",
          headers: getAuthHeaders(),
          body: JSON.stringify(submitData),
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">
            Please login to access staff management
          </p>
          <a
            href="/login"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <StaffSearchModal
        ...
        title={
          actionType === "leave"
            ? "Select Staff for Leave Request"
            : "Select Staff for Loan Application"
        }
        staffList={staff}
      />
            ...
            {stats && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <StatsCard
                  ...
                  value={formatCurrency(stats.total_monthly_salary)}
                  icon={DollarSign}
                  color="purple"
                />
              </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="mt-2 text-sm font-medium text-gray-900">
                          {formatCurrency(member.basic_salary)}
                        </div>
                      </td>
                      <td className="px-6 py-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, nssf_no: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, nhif_no: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 ${validationErrors.emergency_contact_name ? "border-red-500" : "border-gray-300"}`}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <input
                    ...
                    required
                    className={`w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 ${validationErrors.emergency_contact_phone ? "border-red-500" : "border-gray-300"}`}
                  />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="p-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Upload an Excel file with staff data. Download the template
                  for correct format.
                </p>
                <button
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="flex items-center mb-6">
                ...
                <span
                  className={`ml-auto px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedStaff.status)}`}
                >
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between py-1 border-b border-gray-100">
                      ...
                      <span className="text-sm text-gray-900">
                        {selectedStaff.marital_status || "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between py-1 border-b border-gray-100">
                      ...
                      <span className="text-sm text-gray-900">
                        {selectedStaff.employment_type || "N/A"}
                      </span>
                    </div>
                    <div className="flex justify-between py-1 border-b border-gray-100">
                      <span className="text-sm text-gray-600">
                    ...
                    {selectedStaff.contract_end_date && (
                      <div className="flex justify-between py-1 border-b border-gray-100">
                        ...
                        <span className="text-sm text-gray-900">
                          {formatDate(selectedStaff.contract_end_date)}
                        </span>
                      </div>
                    )}
                    <div className="flex justify-between py-1 border-b border-gray-100">
                      ...
                      <span className="text-sm text-gray-900">
                        {formatDate(selectedStaff.employment_date)}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center py-1 border-b border-gray-100">
                      ...
                      <span className="text-sm text-gray-900">
                        {selectedStaff.personal_phone || "N/A"}
                      </span>
                    </div>
                    <div className="flex items-center py-1 border-b border-gray-100">
                      <Mail className="w-4 h-4 text-gray-400 mr-2" />
                      <span className="text-sm text-gray-900">
                        {selectedStaff.personal_email || "N/A"}
                      </span>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-900">
                            {selectedStaff.account_number || "N/A"}
                          </p>
                        </div>
