...
const SettingsProfile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    joinDate: '2015-08-15',
    employeeId: 'PR-2015-001',
    bio: 'Experienced educational leader with over 20 years in school administration. Committed to academic excellence and student development.',
    qualifications: [
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 text-center">
            <div className="relative inline-block">
              <div className="w-32 h-32 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center text-white text-4xl font-bold mx-auto shadow-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800">9 years</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button className="px-3 py-1 border border-dashed border-gray-300 rounded-full text-sm text-gray-500 hover:border-blue-500">
                    + Add Language
                  </button>
                </div>
              </div>
