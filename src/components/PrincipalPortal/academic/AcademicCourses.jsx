...
import {
  ...
  Award, CheckCircle, Calendar, GraduationCap
} from 'lucide-react';
...
const AcademicCourses = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      hours: 3,
      students: 85,
      instructor: 'Ms. Jennifer Thompson',
      status: 'Active',
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-gray-800">{courseStats.totalCourses}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-blue-600">{courseStats.totalEnrollments}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <p className="text-sm text-gray-600">Average Class Size</p>
          <p className="text-2xl font-bold text-purple-600">{courseStats.avgClassSize}</p>
        </div>
      </div>
