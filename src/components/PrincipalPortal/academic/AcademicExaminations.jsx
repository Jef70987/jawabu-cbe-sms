...
const AcademicExaminations = () => {
  ...
  const examStats = {
    upcomingExams: 3,
    totalSubjects: 18,
    registeredStudents: 2450,
    examinationVenues: 30
  };
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          ...
          <p className="text-2xl font-bold text-gray-800">{examStats.totalSubjects}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <p className="text-sm text-gray-600">Registered Students</p>
          <p className="text-2xl font-bold text-blue-600">{examStats.registeredStudents}</p>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
          <p className="text-sm text-gray-600">Examination Venues</p>
          <p className="text-2xl font-bold text-purple-600">{examStats.examinationVenues}</p>
        </div>
      </div>
