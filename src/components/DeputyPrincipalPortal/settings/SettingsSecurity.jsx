...
const SettingsSecurity = () => {
  ...
  const loginHistory = [
    { date: '2024-04-02 08:30:00', ip: '192.168.1.1', device: 'Chrome on Windows', location: 'Main Office' },
    { date: '2024-04-01 17:15:00', ip: '192.168.1.1', device: 'Chrome on Windows', location: 'Main Office' },
    { date: '2024-03-31 09:00:00', ip: '10.0.0.5', device: 'Safari on iPhone', location: 'Remote' }
  ];
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 pr-10 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                    required
                  />
                  <button
                    type="button"
        ...
        <div className="space-y-6">
          ...
          {/* Trusted Devices */}
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h3 className="font-semibold text-gray-800 mb-3">Trusted Devices</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <Smartphone size={16} className="text-gray-500" />
                  <span className="text-sm">Windows PC - Chrome</span>
                </div>
              ...
              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-2">
                  <Smartphone size={16} className="text-gray-500" />
                  <span className="text-sm">iPhone - Safari</span>
                </div>
                <button className="text-xs text-red-600">Remove</button>
              </div>
            </div>
